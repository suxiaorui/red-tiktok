...
public class GraceExceptionHandler {
    ...
    @ExceptionHandler(com.rui.exceptions.MyCustomException.class)
    @ResponseBody
    public GraceJSONResult returnMyException(com.rui.exceptions.MyCustomException e) {
        e.printStackTrace();
